...
//         Inflate the layout for this fragment
        ...
        viewPager = mView.findViewById(R.id.tabLayout_ViewPager)
//
        val adapter= ViewPageAdapter(activity!!.supportFragmentManager)
        adapter.addFragment(TabItem1Fragment(), "Item 1")
        adapter.addFragment(TabItem2Fragment(), "Item 2")
        adapter.addFragment(TabItem3Fragment(), "Item 3")
        viewPager.adapter = adapter

        tabLayout = mView.findViewById(R.id.tabLayoutBar)
